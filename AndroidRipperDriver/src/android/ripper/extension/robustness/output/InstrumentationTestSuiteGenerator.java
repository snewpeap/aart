...
public class InstrumentationTestSuiteGenerator extends TestSuiteGenerator {
...
//        ADSerializable();
    ...
    public InstrumentationTestSuiteGenerator(String AUT_PACKAGE, String coverage, String perturb, String CLASS_NAME) {
    ...
    public static void main(String[] args) throws JsonProcessingException {
        ObjectMapper objectMapper = new ObjectMapper();
        InstrumentationTestSuiteGenerator InstrumentationTestSuiteGenerator = new InstrumentationTestSuiteGenerator("", "lifts", "all", args[0]);
        ...
        reMark(transitions);
        InstrumentationTestSuiteGenerator.generate(transitions);
    }
